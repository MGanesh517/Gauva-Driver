...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m7(amount) =>
      "সফল! আপনি ${amount} উত্তোলনের অনুরোধ করেছেন। অর্থ নির্বাচিত অ্যাকাউন্টে শীঘ্রই স্থানান্তরিত হবে।";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "accept_ride": MessageLookupByLibrary.simpleMessage("রাইড গ্রহণ করুন"),
    ...
    "enter_details_complete_profile": MessageLookupByLibrary.simpleMessage(
      "আপনার প্রোফাইল সম্পূর্ণ করতে এবং অভিজ্ঞতা উন্নত করতে আপনার বিবরণ লিখুন।",
    ),
    ...
    "go_to_login": MessageLookupByLibrary.simpleMessage("লগইনে যান"),
    ...
    "km": MessageLookupByLibrary.simpleMessage("কি.মি."),
    ...
    "nid_photo": MessageLookupByLibrary.simpleMessage("এনআইডি ছবি"),
    ...
    "payment_method": MessageLookupByLibrary.simpleMessage("পেমেন্ট পদ্ধতি"),
    "payment_received": MessageLookupByLibrary.simpleMessage("পেমেন্ট প্রাপ্ত"),
    "payment_withdraw": MessageLookupByLibrary.simpleMessage("পেমেন্ট উত্তোলন"),
    "payout_method": MessageLookupByLibrary.simpleMessage("পেমেন্ট পদ্ধতি"),
    "personal_info": MessageLookupByLibrary.simpleMessage("ব্যক্তিগত তথ্য"),
    ...
    "pickup_rider": MessageLookupByLibrary.simpleMessage("রাইডার তুলুন"),
    "plate_number": MessageLookupByLibrary.simpleMessage("নম্বর প্লেট"),
    "please_enter_amount": MessageLookupByLibrary.simpleMessage(
      "দয়া করে পরিমাণ লিখুন",
    ),
    ...
    "production_year": MessageLookupByLibrary.simpleMessage("উৎপাদন বছর"),
    "profile_image": MessageLookupByLibrary.simpleMessage("প্রোফাইল ছবি"),
    "profile_image_required": MessageLookupByLibrary.simpleMessage(
      "প্রোফাইল ছবি প্রয়োজন",
    ),
    "profile_submitted_reviewed": MessageLookupByLibrary.simpleMessage(
      "আপনার প্রোফাইল জমা হয়েছে এবং রিভিউ চলছে। অনুমোদনের পর আপনাকে জানানো হবে।",
    ),
    ...
    "reached_passenger_destination": MessageLookupByLibrary.simpleMessage(
      "আপনি যাত্রীদের গন্তব্যে পৌঁছেছেন।",
    ),
    "reached_pickup_wait": MessageLookupByLibrary.simpleMessage(
      "আপনি পিকআপ অবস্থানে পৌঁছেছেন। দয়া করে কয়েক মিনিট অপেক্ষা করুন যতক্ষণ না রাইডার আপনার গাড়ির কাছে আসে।",
    ),
    ...
    "rideCharge": MessageLookupByLibrary.simpleMessage("যাত্রার ভাড়া"),
    ...
    "ride_history": MessageLookupByLibrary.simpleMessage("রাইড ইতিহাস"),
    ...
    "start_journey_navigation": MessageLookupByLibrary.simpleMessage(
      "অ্যাপের নেভিগেশন অনুসরণ করে যাত্রা শুরু করুন। শুরু করার আগে উভয় পক্ষের আরাম নিশ্চিত করুন।",
    ),
    ...
    "takeAPhoto": MessageLookupByLibrary.simpleMessage("ছবি তুলুন"),
    "tap_to_confirm_arrival": MessageLookupByLibrary.simpleMessage(
      "আপনার আগমন নিশ্চিত করতে ট্যাপ করুন",
    ),
    ...
    "time_to_pickup": MessageLookupByLibrary.simpleMessage(
      "রাইডারকে তোলার সময়! নেভিগেশন অনুসরণ করুন এবং দেরি না করে পৌঁছান",
    ),
    "today": MessageLookupByLibrary.simpleMessage("আজ"),
    "todays_activity": MessageLookupByLibrary.simpleMessage("আজকের কার্যক্রম"),
    "todays_earning": MessageLookupByLibrary.simpleMessage("আজকের উপার্জন"),
    ...
    "total_distance": MessageLookupByLibrary.simpleMessage("মোট দূরত্ব"),
    "total_rides": MessageLookupByLibrary.simpleMessage("মোট রাইড"),
    ...
    "trip_ended_passenger_destination": MessageLookupByLibrary.simpleMessage(
      "যাত্রা শেষ হয়েছে কারণ যাত্রী তার গন্তব্যে পৌঁছেছে।",
    ),
    ...
    "your_balance": MessageLookupByLibrary.simpleMessage("আপনার ব্যালেন্স"),
    "your_best_photo_here": MessageLookupByLibrary.simpleMessage(
      "এখানে আপনার সেরা ছবি দিন",
    ),
    "your_ride_complete": MessageLookupByLibrary.simpleMessage("রাইড সম্পন্ন"),
  };
}
