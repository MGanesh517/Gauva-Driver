...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [account, home, rideHistory, wallet];
}
...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/no-data-found.svg
  String get noDataFound => 'assets/svg/no-data-found.svg';

  /// File path: assets/svg/no-internet.svg
  String get noInternet => 'assets/svg/no-internet.svg';

  /// List of all assets
  List<String> get values => [noDataFound, noInternet];
}

class $AssetsVehiclesGen {
  const $AssetsVehiclesGen();

  /// File path: assets/vehicles/bike.png
  AssetGenImage get bike => const AssetGenImage('assets/vehicles/bike.png');

  /// File path: assets/vehicles/car.png
  AssetGenImage get car => const AssetGenImage('assets/vehicles/car.png');

  /// File path: assets/vehicles/suv.png
  AssetGenImage get suv => const AssetGenImage('assets/vehicles/suv.png');

  /// List of all assets
  List<AssetGenImage> get values => [bike, car, suv];
}
...
class Assets {
  ...
  static const String notification2 = 'assets/notification2.mp3';
